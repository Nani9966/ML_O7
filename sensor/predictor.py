...
class ModelResolver:
    ...
    def get_latest_model_path(self):
        try:
            ...
            if latest_dir is None:
                raise Exception(f"modelis not available")
    ...
    def get_latest_transformer_path(self):
        try:
            latest_dir=self.get_latest_dir_path()
            if latest_dir is None:
                raise Exception(f"Trasformer is not avalible")
    ...
    def get_latest_target_encoder_path(self):
        try:
            ...
            if latest_dir == None:
                raise Exception(f"Target encoder is not avliable")   
    ...
    def get_latest_save_dir_path(self)->str:
        try:
            ...
            return os.path.joun(self.model_registry,f"{latest_dir_num+1}")
        except Exception as e:
            return e
