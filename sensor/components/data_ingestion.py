...
class DataIngestion:
    ...
    def initiate_data_ingestion(self)->artifact_entity.DataIngesionArtifact:
        try:
            ...
            #create database directory floder if not avalbile
            dataset_dir=os.path.dirname(self.data_ingestion_config.train_file_path)
            os.makedirs(dataset_dir,exist_ok=True)

            #save df to feature store floder 
            ...
            #prepare Artifact
            Data_ingestion_artifact =artifact_entity.DataIngesionArtifact(
